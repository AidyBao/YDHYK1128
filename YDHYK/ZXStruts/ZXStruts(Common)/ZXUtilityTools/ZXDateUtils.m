...
#import "ZXDateUtils.h"

@implementation ZXDateUtils
...
+(NSString *)getDateAfterTodayMillSeconds:(NSNumber *)Mseconds{
    ...
    NSString * tDate =[ZXDateUtils dateFromMilliSecond:[NSNumber numberWithLongLong:sTime] isCHN:false needTime:false splitChar:@"-"];
    return tDate;
}
