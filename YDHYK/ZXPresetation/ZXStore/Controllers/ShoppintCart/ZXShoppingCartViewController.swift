...
class ZXShoppingCartViewController: ZXSTUIViewController {
    ...
    var emptyHeaderView: UIView = {
        let view = UIView.init(frame: CGRect(x: 0, y: 0, width: ZX.BOUNDS_WIDTH, height: 200))
        view.backgroundColor = UIColor.zx_assist()
        ...
        label.textColor = UIColor.zx_sub2Text()
        label.font = UIFont.zx_bodyFont(withSize: zx_bodyFontSize())
