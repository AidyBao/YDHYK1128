...
class ZXSegment: UIView {
    ...
    fileprivate var menuWidth: CGFloat = ZX.BOUNDS_WIDTH
    ...
    init(origin:CGPoint, mWidth: CGFloat) {
        ...
        slider.backgroundColor = UIColor.zx_tint()
    ...
    fileprivate func reloadData() {
        ...
        if let count = dataSource?.numberOfTitles(in: self) {
            ...
            for i in 0 ..< count {
                ...
                label.font = UIFont.zx_titleFont(withSize: 16)
                label.textColor = UIColor.zx_text()
                label.highlightedTextColor = UIColor.zx_tint()
                if i == 0 {
