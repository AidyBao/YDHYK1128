...
#import "FAFQRViewController.h"
#import <AVFoundation/AVFoundation.h>
#import "UIView+SDExtension.h"
static const CGFloat kBorderW = 100;
static const CGFloat kMargin = 30;
@interface FAFQRViewController ()<UIAlertViewDelegate,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>{
...
@implementation FAFQRViewController
...
-(void)setupTipTitleView{
    ...
    //1.补充遮罩
    UIView*mask=[[UIView alloc]initWithFrame:CGRectMake(0, _maskView.sd_y+_maskView.sd_height, self.view.sd_width, self.view.bounds.size.height-_maskView.sd_y-_maskView.sd_height)];
...
-(void)setupNavView{
    ...
    backBtn.frame = CGRectMake(20, 30, 25, 20);
...
- (void)setupScanWindowView
{
    ...
    UIButton *topRight = [[UIButton alloc] initWithFrame:CGRectMake(scanWindowW - buttonWH,topLeft.sd_y, buttonWH, buttonWH)];
...
- (void)beginScanning
{
    ...
    //设置扫描范围CGRectMake(Y,X,H,W),1代表最大值，原点是导航右上角
